...
class MLPFeedForward(nn.Module):
    """
    Standard FFN replacing KAN-FFN:
...
# ============================================================
# GraphAttentionKANHead (multitask, early node head)
# ============================================================
class GraphAttentionKAN(nn.Module):
    ...
    def __init__(
        ...
        # ignored block KAN params kept for interface compatibility
